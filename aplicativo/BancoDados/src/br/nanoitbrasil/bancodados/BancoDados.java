package br.nanoitbrasil.bancodados;
...
public class BancoDados  {
	...
	private int VERSAO_BANCO;
	
	public BancoDados(Context context,String[] scriptCriarDB, String scriptApagarDB,String nomeBancoDados,int versaoBanco) {
